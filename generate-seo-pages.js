...
for (const car of carFitments) {
  ...
  const title = `Шини для ${car.brand} ${car.model} ${car.generation} купити в Ковелі | TireTop`;
  const description = `Підбір шин для ${car.brand} ${car.model} ${car.generation} ${car.yearFrom}-${car.yearTo}. Рекомендовані розміри, каталог шин у Ковелі, консультація TireTop.`;
